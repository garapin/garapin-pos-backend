...
const createMerchant = async (req, res) => {
  try {
    ...
    const ConfigAppMerchantModel = merchantDatabase.model(
      "config_app",
      configAppForPOSSchema
    );

    const ConfigAppAdmin = await ConfigAppMerchantModel.find();

    const ConfigAppMerchantTurunanModel = database.model(
      "config_app",
      configAppForPOSSchema
    );
